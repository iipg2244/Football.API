...
//                    ((await _managerService.GetManagerByIdAsync(match.HouseManagerId)) != null &&
//                        (await _managerService.GetManagerByIdAsync(match.AwayManagerId)) != null &&
...
//                    }
//                    if ((await _managerService.GetManagerByIdAsync(match.HouseManagerId)) != null)
//                    {
//                        matchTmp.HouseManagerId = match.HouseManagerId;
//                    }
//                    if ((await _managerService.GetManagerByIdAsync(match.AwayManagerId)) != null)
//                    {
