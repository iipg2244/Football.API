...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DDBB.Manager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DDBB.Match", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DDBB.Player", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DDBB.PlayerMatchAway", b =>
                {
            ...
            modelBuilder.Entity("DDBB.PlayerMatchHouse", b =>
                {
                    b.Property<int>("MatchId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DDBB.Referee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DDBB.Match", b =>
                {
                    b.HasOne("DDBB.Manager", "AwayManager")
                    ...
                    b.HasOne("DDBB.Manager", "HouseManager")
            ...
            modelBuilder.Entity("DDBB.PlayerMatchAway", b =>
                {
                    b.HasOne("DDBB.Match", "Match")
                        .WithMany("AwayPlayers")
                        .HasForeignKey("MatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DDBB.Player", "Player")
